...
def loaded_model():
    ...
    #json_file = open('/home/jzhang/code/network2/model_zinc250k_std_woSsP+-_LSTM256tanh_LSTM256tanh_epoch20.json', 'r')
    json_file = open('/home/jzhang/code/ChemTS/train_RNN/model20191019.json', 'r')
    ...
    #loaded_model.load_weights('/home/jzhang/code/network2/model_zinc250k_std_woSsP+-_LSTM256tanh_LSTM256tanh_epoch20.h5')
    loaded_model.load_weights('/home/jzhang/code/ChemTS/train_RNN/model20191019.h5')
